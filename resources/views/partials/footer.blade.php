    ...
    <div class="container mx-auto px-4 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-600">
                    <li><a href="#" class="hover:text-red-800 transition-colors">Assinaturas</a></li>
            ...
            <div>
                <h3 class="text-lg font-bold text-gray-900 mb-4 font-serif">Newsletter</h3>
                <p class="text-sm text-gray-600 mb-4">
                    Receba nossas notícias e artigos exclusivos em seu e-mail.
                </p>
                <form class="space-y-2">
                    <input 
                        type="email" 
                        placeholder="Seu e-mail" 
                        class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent text-sm"
                    >
                    <button 
                        type="submit" 
                        class="w-full bg-red-800 text-white px-4 py-2 rounded hover:bg-red-900 transition-colors text-sm font-medium"
                    >
                        Assinar
                    </button>
                </form>
                <div class="mt-6 flex space-x-4">
                    <a href="#" class="text-gray-600 hover:text-red-800 transition-colors">
