                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="font-medium">{{ number_format($article->views ?? 0, 0, ',', '.') }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex gap-2">
                                        @php
                                            $articleShowUrl = \App\Support\ArticleUrl::showUrl($article);
                                        @endphp
                                        @if($articleShowUrl)
                                        <a href="{{ $articleShowUrl }}" target="_blank" class="text-blue-600 hover:text-blue-900" title="Visualizar">
