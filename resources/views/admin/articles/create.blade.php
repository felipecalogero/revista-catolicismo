            ...
            <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="article-form">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-800 focus:border-transparent"
                    >
                    <p class="mt-1 text-sm text-gray-500">Formatos aceitos: JPEG, PNG, JPG, GIF, WEBP (máx. 5MB). Recomendado: imagem horizontal, mín. 1200×675 px.</p>
                    @error('image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    <label for="image_caption" class="block text-sm font-medium text-gray-700 mb-2">
                        Legenda da imagem <span class="text-red-600">*</span>
                    </label>
                    <textarea
                        id="image_caption"
                        name="image_caption"
