                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Data da Edição (Mês e Ano) <span class="text-red-600">*</span>
                        </label>
                            ...
                            <div>
                                ...
                                >
                                    @foreach(range(1, 12) as $month)
                                        <option value="{{ $month }}" {{ (old('release_month', $edition->release_date ? $edition->release_date->format('n') : date('n')) == $month) ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                >
                                    @php
                                        ...
                                        $endYear = 1951;
                                        $selectedYear = old('release_year', $edition->release_date ? $edition->release_date->format('Y') : $currentYear);
                                    @endphp
                        ...
                        <p class="mt-1 text-sm text-gray-500">Esta data será usada para a regra de acesso (gratuitas após 5 meses)</p>
                        @error('release_month') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    ...
                    <div>
                        ...
                        @if($edition->cover_image_url)
                            <div class="mb-3">
                                <img src="{{ $edition->cover_image_url }}" alt="{{ $edition->title }}" class="w-32 h-44 object-cover rounded border border-gray-300">
                    ...
                    <div>
                        ...
                        @if($edition->pdf_file)
                            <div class="mb-3">
                                <a href="{{ $edition->pdf_file_url }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-2">
