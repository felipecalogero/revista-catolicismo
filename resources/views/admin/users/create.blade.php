                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="flex items-center mb-4">
                        <input
                            ...
                            value="1"
                            {{ old('subscription_active') ? 'checked' : '' }}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="monthly" {{ old('subscription_plan') === 'monthly' ? 'selected' : '' }}>Mensal</option>
                                <option value="yearly" {{ old('subscription_plan') === 'yearly' ? 'selected' : '' }}>Anual</option>
                            </select>
