...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->string('subscription_plan')->nullable()->after('subscription_end_date'); // Ex: 'monthly', 'yearly'
        });
    }
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropColumn(['subscription_active', 'subscription_start_date', 'subscription_end_date', 'subscription_plan']);
        });
    }
};
